/**
 * Дэвсгэрийн чимэглэл. Зөвхөн харагдах зориулалттай тул дэлгэц уншигчаас
 * нуусан.
 */
export function BackgroundBlobs() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
      <div className="absolute -right-24 top-16 h-72 w-72 rounded-full bg-[#e3edfc] opacity-70" />
...
/** Доод хэсгийн уул, мод, сургуулийн дүрс. */
export function BottomLandscape() {
  return (
    ...
    >
      <path d="M0 150 L90 96 L150 150 Z M120 150 L200 88 L280 150 Z" fill="currentColor" opacity="0.75" />
      ...
      <g fill="currentColor" opacity="0.85">
        ...
        <rect x="840" y="132" width="16" height="28" rx="3" fill="#f6faff" />
      </g>
